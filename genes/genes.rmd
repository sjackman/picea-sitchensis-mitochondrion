...
# Load data
```{r load-data}
gff.all <- readGff3("psitchensismt_12.gff", isRightOpen = FALSE)
gff <- gff.all[gff.all$type %in% c('mRNA', 'rRNA', 'tRNA'),]

scaffold_sizes <- read_tsv("psitchensismt_12.fa.fai",
...
write.table(data_grouped, 'psitchensismt_12.gff.family.tsv',
