...
# Load data
```{r load-data}
gff.all <- readGff3("psitchensismt.1.gff", isRightOpen = FALSE)
gff <- gff.all[gff.all$type %in% c('mRNA', 'rRNA', 'tRNA'),]

scaffold_sizes <- read_tsv("psitchensismt.1.fa.fai",
...
write.table(data_grouped, 'psitchensismt.1.gff.family.tsv',
