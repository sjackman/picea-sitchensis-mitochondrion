...
# Load data
```{r load-data}
gff_all <- readGff3("psitchensismt.gff", isRightOpen = FALSE, quiet = TRUE)

gff <- gff_all[gff_all$type %in% c('mRNA', 'rRNA', 'tRNA'),]

scaffold_sizes <- read_tsv("psitchensismt.fa.fai",
...
write_tsv(data_grouped, "psitchensismt.gff.family.tsv")
```
