...
miniasm: \
	Q903_6.minimap2.miniasm.gfa.png \
	Q903_6.minimap2.miniasm.minimap2.psitchensiscpmt_8.paf.gz
...
Q903_6.fq.gz: data/FAH26226-cleaned.fastq data/FAH26380-cleaned.fastq data/FAH26689-cleaned.fastq data/FAH26719-cleaned.fastq data/FAH26768-cleaned.fastq data/FAH26843-cleaned.fastq
	$(gzip) -c $^ >$@
